...
cp -R openclaw-pm-skills/skills/ga4-data-api ~/.openclaw/workspace/skills/
```

Then read:

```text
~/.openclaw/workspace/skills/ga4-data-api/SKILL.md
```
...
For `ga4-data-api`, the minimum validation is:
...
- First valid skill: **`ga4-data-api`**
